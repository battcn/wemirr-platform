...
| 版本        | 描述                                                           |
|-----------|--------------------------------------------------------------|
| v1-dev    | JDK8 - JDK11 的请使用 vben 分支（后续只提供BUG修复）                        |
| v2-master | JDK17、SCA2022、SC2023、OAuth2.1、Security 请使用 v2-dev 分支（推荐）     |
| v3-dev    | JDK17、SCA2022、SC2023、Sa-Token 请使用 v3-dev 分支（强烈推荐,因为作者后期重心在它） |
