...
> JDK8 - JDK11 的请使用 vben 分支

> JDK17+SCA2022+SC2023 请使用 vben_jdk17 分支

> 开发文档

**请看项目 `开发文档` 目录下的相关 md 文件,同时需要搞懂租户策略已经配置规则，暂时没有保姆级文档，如果有问题可以加作者微信反馈（错误截图,看到会回,项目怎么启动之类的请看粗略的文档，或者`付费远程`），QQ群暂时不用了（MAC QQ太吃内存32G也扛不住）**

> 付费功能

**可以进微信群交流和提需求（提了不一定做,请理性付费）**
**提供技术支持远程协助（项目启动问题或BUG免费）**
