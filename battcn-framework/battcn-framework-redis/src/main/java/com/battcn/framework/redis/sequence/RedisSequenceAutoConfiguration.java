...
import com.battcn.framework.redis.RedisConstant;
...
public class RedisSequenceAutoConfiguration {
    ...
    @Autowired
    public RedisSequenceAutoConfiguration(RedisSequenceProperties redisSequenceProperties) {
    ...
    public StringRedisTemplate sequenceRedisTemplate() {
        ...
        final JedisConnectionFactory jedisConnectionFactory = jedisConnectionFactory();
    ...
    public SequenceRedisHelper sequenceRedisHelper(StringRedisTemplate sequenceRedisTemplate) {
