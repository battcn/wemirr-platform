 ...
 **/
@Data
@Schema(description = "已办任务返回体")
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DoneTaskPageResp {
    ...
    @Schema(description = "审批类型 PASS-通过 REJECT-驳回  REFUSE-拒绝")
    private ApprovalAction skipType;
    ...
    public String getSkipTypeName() {
        return skipType == null ? null :skipType.getLabel();
    }
}