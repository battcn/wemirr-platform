//package com.wemirr.platform.warmflow.listener.base;
//
...
//                flowTask.setPermissionList(List.of(userIds.split(StrUtil.SEPARATOR)));
...
//        if (StrUtil.isNotBlank(flowStatus) && ApprovalStatus.initialState(flowStatus)) {
...
//                String status = ApprovalStatus.FINISH.getStatus();
//                // 更新流程状态为已完成
