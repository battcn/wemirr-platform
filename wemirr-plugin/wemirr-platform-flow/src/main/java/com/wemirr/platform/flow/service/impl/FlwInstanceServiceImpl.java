...
//import com.wemirr.platform.warmflow.configuration.common.enums.TaskStatusEnum;
//import com.wemirr.platform.warmflow.configuration.handler.FlowProcessEventHandler;
//import com.wemirr.platform.warmflow.domain.bo.FlowCancelBo;
//import com.wemirr.platform.warmflow.domain.bo.FlowInstanceBo;
//import com.wemirr.platform.warmflow.domain.enums.ApprovalStatus;
//import com.wemirr.platform.warmflow.domain.vo.FlowHisTaskVo;
//import com.wemirr.platform.warmflow.domain.vo.FlowInstanceVo;
//import com.wemirr.platform.warmflow.repository.FlwCategoryMapper;
//import com.wemirr.platform.warmflow.repository.FlwInstanceMapper;
//import com.wemirr.platform.warmflow.service.IFlwInstanceService;
...
//        queryWrapper.in("fi.flow_status", ApprovalStatus.runningStatus());
...
//        QueryWrapper<FlowInstanceBo> queryWrapper = buildQueryWrapper(flowInstanceBo);
//        queryWrapper.in("fi.flow_status", ApprovalStatus.finishStatus());
//        Page<FlowInstanceVo> page = flwInstanceMapper.selectInstanceList(pageQuery.build(), queryWrapper);
//        return TableDataInfo.build(page);
//    }
//
...
//        queryWrapper.like(StrUtil.isNotBlank(flowInstanceBo.getNodeName()), "fi.node_name", flowInstanceBo.getNodeName());
//        queryWrapper.like(StrUtil.isNotBlank(flowInstanceBo.getFlowName()), "fd.flow_name", flowInstanceBo.getFlowName());
//        queryWrapper.like(StrUtil.isNotBlank(flowInstanceBo.getFlowCode()), "fd.flow_code", flowInstanceBo.getFlowCode());
//        if (StrUtil.isNotBlank(flowInstanceBo.getCategory())) {
...
//        }
//        queryWrapper.eq(StrUtil.isNotBlank(flowInstanceBo.getBusinessId()), "fi.business_id", flowInstanceBo.getBusinessId());
...
//            if (instance == null) {
//                throw new CheckedException(ExceptionCons.NOT_FOUNT_INSTANCE);
//            }
//            Definition definition = defService.getById(instance.getDefinitionId());
//            if (definition == null) {
//                throw new CheckedException(ExceptionCons.NOT_FOUNT_DEF);
//            }
//            String message = bo.getMessage();
//            String userIdStr = String.valueOf(context.userId());
//            ApprovalStatus.checkCancelStatus(instance.getFlowStatus());
//            FlowParams flowParams = FlowParams.build()
//                .message(message)
//                .flowStatus(ApprovalStatus.CANCEL.getStatus())
//                .hisStatus(ApprovalStatus.CANCEL.getStatus())
//                .handler(userIdStr)
//                .ignore(true);
...
//                }
//                if (ApprovalStatus.isDraftOrCancelOrBack(flowInstance.getFlowStatus())) {
//                    flowHisTaskVo.setApprover(String.valueOf(context.userId()));
//                    flowHisTaskVo.setApproveName(String.valueOf(context.nickName()));
//                }
//            }
...
//                .flowStatus(ApprovalStatus.INVALID.getStatus())
