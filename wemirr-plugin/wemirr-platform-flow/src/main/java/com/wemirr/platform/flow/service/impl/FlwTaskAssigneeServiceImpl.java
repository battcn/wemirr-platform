...
//import org.dromara.common.core.utils.StrUtil;
...
//            .setHandlerCode(assignee -> StrUtil.blankToDefault(assignee.getHandlerCode(), "无"))
//            .setHandlerName(assignee -> StrUtil.blankToDefault(assignee.getHandlerName(), "无"))
//            .setGroupName(assignee -> StrUtil.defaultIfBlank(
...
//        if (StrUtil.isEmpty(storageIds)) {
//            return List.of();
//        }
//        Map<TaskAssigneeEnum, List<Long>> typeIdMap = new EnumMap<>(TaskAssigneeEnum.class);
//        for (String storageId : storageIds.split(StrUtil.SEPARATOR)) {
//            Pair<TaskAssigneeEnum, Long> parsed = this.parseStorageId(storageId);
//            if (parsed != null) {
//                typeIdMap.computeIfAbsent(parsed.getKey(), k -> new ArrayList<>()).add(parsed.getValue());
//            }
