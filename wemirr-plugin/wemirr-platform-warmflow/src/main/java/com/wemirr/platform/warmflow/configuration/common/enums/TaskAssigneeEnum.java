package com.wemirr.platform.warmflow.configuration.common.enums;
...
public enum TaskAssigneeEnum {
     ...
     * 根据描述获取对应的枚举类型
     * <p>
     * 通过传入描述，查找并返回匹配的枚举项。如果未找到匹配项，会抛出 {@link CheckedException}。
     * </p>
     *
     * @param desc 描述，用于匹配对应的枚举项
     * @return TaskAssigneeEnum 返回对应的枚举类型
     * @throws CheckedException 如果未找到匹配的枚举项
     */
    public static TaskAssigneeEnum fromDesc(String desc) {
        ...
        throw new CheckedException("未知的办理人类型: " + desc);
    }

    /**
     * 根据代码获取对应的枚举类型
     * <p>
     * 通过传入代码，查找并返回匹配的枚举项。如果未找到匹配项，会抛出 {@link CheckedException}。
     * </p>
     *
    ...
    public static TaskAssigneeEnum fromCode(String code) {
        ...
        throw new CheckedException("未知的办理人类型代码: " + code);
    }
