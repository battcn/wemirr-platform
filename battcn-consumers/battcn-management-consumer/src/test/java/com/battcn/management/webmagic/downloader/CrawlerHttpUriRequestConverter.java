 ...
 *         2018年1月22日
 */
public class CrawlerHttpUriRequestConverter extends HttpUriRequestConverter {
    ...
    private HttpClientContext convertHttpClientContext(Request request, Site site, Proxy proxy) {
        ...
        if (proxy != null && proxy.getUsername() != null) {
            ...
            authState.update(new BasicScheme(Charset.forName("UTF-8")), new UsernamePasswordCredentials(proxy.getUsername(), proxy.getPassword()));
    ...
    private HttpUriRequest convertHttpUriRequest(Request request, @NotNull Site site, Proxy proxy) {
