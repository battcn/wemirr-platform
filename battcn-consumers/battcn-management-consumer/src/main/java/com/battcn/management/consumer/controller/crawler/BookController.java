...
public class BookController extends BaseController {
    ...
    public ApiResult<String> crawler() {
        ...
        Executors.newSingleThreadExecutor().execute(() -> Spider.create(new BookProcessor()).setDownloader(crawlerDownloader).addUrl(BookProcessor.ALL_BOOK_LINK).addPipeline(bookPipeline).thread(5).run());
