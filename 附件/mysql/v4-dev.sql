...
-- ----------------------------
BEGIN;
INSERT INTO `c_i18n_data` (`id`, `code`, `remark`, `tenant_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1, 'SEX.1', '性别->男', 1, b'0', 0, NULL, '2024-07-19 09:06:38', 0, NULL, '2024-07-19 09:18:35');
...
INSERT INTO `c_i18n_data` (`id`, `code`, `remark`, `tenant_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1721821542981042178, 'i18n.db', '测试中文内容 {i18n.demo}', 1, b'0', 1, '长风一梦0000', '2023-11-07 17:27:00', NULL, NULL, '2024-12-06 17:09:22');
...
-- ----------------------------
BEGIN;
INSERT INTO `c_i18n_locale_message` (`id`, `parent_id`, `locale`, `message`, `create_by`, `create_name`, `create_time`) VALUES (10, 1, 'zh_CN', '男', 1, NULL, '2024-07-19 09:07:18');
INSERT INTO `c_i18n_locale_message` (`id`, `parent_id`, `locale`, `message`, `create_by`, `create_name`, `create_time`) VALUES (11, 1, 'en_US', 'Male', 1, NULL, '2024-07-19 09:07:31');
...
INSERT INTO `c_i18n_locale_message` (`id`, `parent_id`, `locale`, `message`, `create_by`, `create_name`, `create_time`) VALUES (1864960309261914113, 1721821542981042178, 'en_US', 'English Context', NULL, NULL, '2024-12-06 17:09:22');
INSERT INTO `c_i18n_locale_message` (`id`, `parent_id`, `locale`, `message`, `create_by`, `create_name`, `create_time`) VALUES (1864960309274497026, 1721821542981042178, 'zh_CN', '测试中文内容 {i18n.demo}', NULL, NULL, '2024-12-06 17:09:22');
COMMIT;
...
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (32002, '文件管理', '', 320, '/sys/storage/file', '/wemirr/system/storage/file/index', 32002, 'hugeicons:folder-attachment', 'menu', b'1', b'1', b'0', b'0', b'1', NULL, NULL, b'0', 1, '平台管理员', '2024-12-06 14:52:11', 1, '平台管理员', '2024-12-15 22:40:52');
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (32003, '配置管理', '', 320, '/sys/storage/setting', '/wemirr/system/storage/setting/index', 32003, 'ep:setting', 'menu', b'1', b'1', b'0', b'0', b'1', NULL, NULL, b'0', 1, '平台管理员', '2024-12-06 14:52:11', 1, '平台管理员', '2024-12-15 22:40:43');
...
CREATE TABLE `t_file_storage` (
                                  ...
                                  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1998974316859228163 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文件记录表';
