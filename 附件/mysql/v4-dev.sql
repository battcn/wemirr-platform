...
CREATE TABLE `c_login_log` (
                               ...
                               `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2001289681630818307 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='登录日志';

-- ----------------------------
-- Records of c_login_log
-- ----------------------------
BEGIN;
INSERT INTO `c_login_log` (`id`, `tenant_id`, `tenant_code`, `ip`, `location`, `client_id`, `principal`, `platform`, `engine`, `browser`, `os`, `login_type`, `create_by`, `create_name`, `create_time`) VALUES (2000526237411831810, 1, '0000', '127.0.0.1', '0|0|0|内网IP|内网IP', 'pc-web', 'admin', 'Desktop', 'Webkit', 'Chrome', 'Mac OS X', 'slider', 1, '平台管理员', '2025-12-15 19:19:58');
INSERT INTO `c_login_log` (`id`, `tenant_id`, `tenant_code`, `ip`, `location`, `client_id`, `principal`, `platform`, `engine`, `browser`, `os`, `login_type`, `create_by`, `create_name`, `create_time`) VALUES (2001096519402536961, 1, '0000', '192.168.19.166', '0|0|0|内网IP|内网IP', 'pc-web', 'admin', 'Desktop', 'Webkit', 'Chrome', 'Mac OS X', 'slider', 1, '平台管理员', '2025-12-17 09:06:03');
INSERT INTO `c_login_log` (`id`, `tenant_id`, `tenant_code`, `ip`, `location`, `client_id`, `principal`, `platform`, `engine`, `browser`, `os`, `login_type`, `create_by`, `create_name`, `create_time`) VALUES (2001289681630818306, 1, '0000', '2408:820c:d09:23b0:2dae:6bd5:6cb:b128', '内网', 'pc-web', 'admin', 'Desktop', 'Webkit', 'Chrome', 'Mac OS X', 'slider', 1, '平台管理员', '2025-12-17 21:53:37');
COMMIT;
...
CREATE TABLE `c_opt_log` (
                             ...
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2000485205491986434 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='系统日志';

-- ----------------------------
-- Records of c_opt_log
-- ----------------------------
BEGIN;
INSERT INTO `c_opt_log` (`id`, `tenant_id`, `tenant_code`, `module`, `description`, `ip`, `location`, `trace`, `action`, `uri`, `http_method`, `request`, `response`, `message`, `status`, `start_time`, `end_time`, `duration`, `browser`, `os`, `engine`, `platform`, `token`, `create_by`, `create_name`) VALUES (2000485205491986433, 1, '0000', '流程分类', '新增流程分类', '127.0.0.1', '0|0|0|内网IP|内网IP', '005bba10-fa49-4fd2-b715-760ae065ecca', 'com.wemirr.platform.workflow.controller.FlowCategoryController.create', '/flow-categories', 'POST', '[{\"description\":\"测试分类\",\"icon\":\"fa-brands:first-order\",\"name\":\"测试分类\",\"status\":true}]', 'null', NULL, b'1', '2025-12-15 16:36:55', '2025-12-15 16:36:55', 14, 'Chrome', 'Mac OS X', 'Webkit', 'Desktop', 'Bearer 99448928-a817-4ac3-bbc0-b608249cfda8', 1, '平台管理员');
COMMIT;
...
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (110201, '发起审批', NULL, 1102, '/workflow/process/launch', '/wemirr/workflow/process/launch/index', 0, 'gridicons:create', 'menu', b'1', b'1', b'0', b'0', b'1', NULL, '', b'0', 1603373363570712578, '不会说话的人', '2023-02-23 07:16:04', NULL, NULL, NULL);
