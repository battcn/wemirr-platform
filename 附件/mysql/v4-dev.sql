...
) ENGINE=InnoDB AUTO_INCREMENT=2001521973171200004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='数据权限资源表';
...
CREATE TABLE `sys_dict` (
                            ...
                            PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1700070256599982209 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='字典类型';
...
) ENGINE=InnoDB AUTO_INCREMENT=2001485026553892867 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='菜单';
...
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (2001483813821222913, '测试菜单效果', 'test:menu', 0, '/test/menu', 'BasicLayout', 111110, 'carbon:align-box-middle-left', 'directory', b'1', NULL, b'0', b'0', b'1', NULL, '', b'0', 1, '平台管理员', '2025-12-18 10:45:02', 1, '平台管理员', '2025-12-18 10:45:10');
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (2001483967097868289, '测试子菜单', '测试子菜单', 2001483813821222913, '/testsss', '/wemirr/platform/tenant/index222', 11, 'carbon:arrange', 'menu', b'1', NULL, b'0', b'0', b'1', NULL, '', b'0', 1, '平台管理员', '2025-12-18 10:45:38', 1, '平台管理员', '2025-12-18 10:49:35');
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (2001485011257266178, '13231', '123', 2001483967097868289, '', NULL, 0, '', 'button', b'1', NULL, b'0', b'0', b'1', NULL, '123', b'0', 1, '平台管理员', '2025-12-18 10:49:47', NULL, NULL, NULL);
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `meta`, `description`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (2001485026553892866, '213', '213', 2001483967097868289, '', NULL, 0, '', 'button', b'1', NULL, b'0', b'0', b'1', NULL, '213', b'0', 1, '平台管理员', '2025-12-18 10:49:51', NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_role_res` (
                                ...
                                `last_modify_time` datetime DEFAULT NULL COMMENT '最近修改时间',
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2001549603656339472 DEFAULT CHARSET=utf8mb3 COMMENT='角色权限表';
