...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` (`id`, `tenant_id`, `username`, `password`, `nick_name`, `org_id`, `position_id`, `readonly`, `email`, `mobile`, `id_card`, `sex`, `status`, `avatar`, `description`, `nation`, `education`, `position_status`, `birthday`, `last_login_ip`, `last_login_time`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1, 1, 'admin', '{bcrypt}$2a$10$R2AdNVf402GnqcJejdjY..wOHP5hFt5x0vz5qXdTVG.udcdFmqu.K', '平台管理员', 100, 100, b'0', '1837307557@qq.com', '13002171111', '000000000000000000', 1, b'1', 'http://127.0.0.1:19000/wp-local/dev/693a856102cefd0cffddf284.png', '平台最帅的超级管理员', 'mz_daiz', 'SUOSHI', 'QUIT', '2023-10-14', '127.0.0.1', '2025-12-15 13:05:03', b'0', 0, '系统管理员', '2020-10-16 03:25:36', NULL, NULL, NULL);
INSERT INTO `t_user` (`id`, `tenant_id`, `username`, `password`, `nick_name`, `org_id`, `position_id`, `readonly`, `email`, `mobile`, `id_card`, `sex`, `status`, `avatar`, `description`, `nation`, `education`, `position_status`, `birthday`, `last_login_ip`, `last_login_time`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (2, 1, 'test', '{bcrypt}$2a$10$sQqVWZrcJtBNLf7dI50B4e7V/xtliLhqiSjGuTgQJmEuKJs4CAiNa', '测试管理员', 10001, 100, b'0', '1300000000@qq.com', '13002171921', '000000000000000000', 1, b'1', 'http://127.0.0.1:19000/wp-local/dev/693a8da302cebd51038e9d25.png', '测试测试测试', 'mz_hanz', 'SUOSHI', 'WORKING', '2023-10-14', NULL, NULL, b'0', 0, '系统管理员', '2022-12-04 08:05:29', 1, '平台管理员', '2025-12-15 12:27:57');
