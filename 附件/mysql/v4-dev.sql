...
INSERT INTO `c_generate_table_column` (`id`, `table_name`, `name`, `sort`, `type`, `comment`, `property_type`, `property_name`, `property_package`, `pk`, `increment`, `required`, `inserted`, `edit`, `create_time`, `create_by`, `create_name`, `last_modify_time`, `last_modify_by`, `last_modify_name`, `deleted`, `tenant_id`, `generate`, `list`, `search`, `search_condition`) VALUES (1893154833222057986, 'b_message_channel', 'create_by', 9, 'bigint', '创建人id', 'Long', 'createBy', NULL, 0, 0, 1, 0, 0, '2025-02-22 12:24:20', 1, '平台管理员', '2025-02-22 12:24:20', NULL, NULL, b'0', 1, 0, 1, 0, 'LIKE');
INSERT INTO `c_generate_table_column` (`id`, `table_name`, `name`, `sort`, `type`, `comment`, `property_type`, `property_name`, `property_package`, `pk`, `increment`, `required`, `inserted`, `edit`, `create_time`, `create_by`, `create_name`, `last_modify_time`, `last_modify_by`, `last_modify_name`, `deleted`, `tenant_id`, `generate`, `list`, `search`, `search_condition`) VALUES (1893154833222057987, 'b_message_channel', 'create_name', 10, 'varchar', '创建人名称', 'String', 'createName', NULL, 0, 0, 1, 0, 0, '2025-02-22 12:24:20', 1, '平台管理员', '2025-02-22 12:24:20', NULL, NULL, b'0', 1, 0, 1, 0, 'LIKE');
INSERT INTO `c_generate_table_column` (`id`, `table_name`, `name`, `sort`, `type`, `comment`, `property_type`, `property_name`, `property_package`, `pk`, `increment`, `required`, `inserted`, `edit`, `create_time`, `create_by`, `create_name`, `last_modify_time`, `last_modify_by`, `last_modify_name`, `deleted`, `tenant_id`, `generate`, `list`, `search`, `search_condition`) VALUES (1893154833230446593, 'b_message_channel', 'create_time', 11, 'datetime', '创建时间', 'Date', 'createTime', 'java.util.Date', 0, 0, 1, 0, 0, '2025-02-22 12:24:20', 1, '平台管理员', '2025-02-22 12:24:20', NULL, NULL, b'0', 1, 0, 1, 0, 'LIKE');
...
CREATE TABLE `sys_user_role` (
                                 ...
                                 `last_modify_time` datetime DEFAULT NULL COMMENT '最近修改时间',
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1999051236422701059 DEFAULT CHARSET=utf8mb3 COMMENT='角色权限表';
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1999051236422701058, 1999051236397535234, 2, 0, 1, '平台管理员', '2025-12-11 17:38:50', NULL, NULL, NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1999346365695938562 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='OSS文件记录';
...
INSERT INTO `oss_file` (`id`, `tenant_id`, `platform`, `category`, `filename`, `original_filename`, `url`, `th_url`, `base_path`, `path`, `ext`, `content_type`, `size`, `th_filename`, `th_size`, `th_content_type`, `object_id`, `object_type`, `metadata`, `user_metadata`, `th_metadata`, `th_user_metadata`, `attr`, `hash_info`, `file_acl`, `th_file_acl`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1999344667019579394, 0, 's3-wp-local', 'IMAGE', '693ba26a28ccaff50c5a9973.png', '新对话 (4).png', 'http://127.0.0.1:19000/wp-local/dev/693ba26a28ccaff50c5a9973.png', '', 'dev/', '', 'png', 'image/png', 3906621, NULL, 0, '', '', '', '{}', '{}', '{}', '{}', '{}', '{}', '', '', b'0', '1', '平台管理员', '2025-12-12 13:04:43', '', '', NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `t_online_form_data` (`id`, `definition_key`, `form_data`, `tenant_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1876938285876658177, 'student', '{\"definitionKey\":\"student\",\"id\":\"1876938285876658177\",\"createName\":\"平台管理员\",\"createTime\":\"2025-01-08T10:25:34Z\",\"name\":\"1\",\"email\":\"1222\"}', NULL, b'0', 1, '平台管理员', '2025-01-08 18:25:34', 1, '平台管理员', '2025-01-09 09:23:23');
INSERT INTO `t_online_form_data` (`id`, `definition_key`, `form_data`, `tenant_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1876938337336573954, 'teacher', '{\"definitionKey\":\"teacher\",\"id\":\"1876938337336573954\",\"createName\":\"平台管理员\",\"createTime\":\"2025-01-08T10:25:46Z\",\"name\":\"花花老师\",\"age\":18,\"remark\":\"你别问\",\"type\":[\"1\",\"4\"]}', NULL, b'0', 1, '平台管理员', '2025-01-08 18:25:46', 1, '平台管理员', '2025-01-09 16:39:34');
INSERT INTO `t_online_form_data` (`id`, `definition_key`, `form_data`, `tenant_id`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1876938382756691969, 'teacher', '{\"definitionKey\":\"teacher\",\"id\":\"1876938382756691969\",\"createName\":\"平台管理员\",\"createTime\":\"2025-01-08T10:25:57Z\",\"name\":\"小安老师\",\"age\":19,\"remark\":\"反差\",\"type\":[\"4\",\"3\"]}', NULL, b'0', 1, '平台管理员', '2025-01-08 18:25:57', 1, '平台管理员', '2025-01-09 16:39:45');
...
INSERT INTO `oss_config` (`id`, `platform`, `tenant_id`, `code`, `type`, `status`, `access_key`, `secret_key`, `bucket_name`, `region`, `domain`, `base_path`, `end_point`, `deleted`, `create_by`, `create_name`, `create_time`, `last_modify_by`, `last_modify_name`, `last_modify_time`) VALUES (1868599415401865217, 's3-wp-local', 1, 's3-wp-local', 's3', 1, 'dQAztlq1gMdAaTfR5i7K', 'S6wpCw8Jo2ujqqs2bgYcBGbp4sOLtvzVy2Yvm6zF', 'wp-local', NULL, 'http://127.0.0.1:19000/wp-local/', 'dev/', 'http://127.0.0.1:19000', b'0', '1', '平台管理员', '2024-12-16 18:09:52', '1', '平台管理员', '2025-12-11 17:30:03');
COMMIT;
