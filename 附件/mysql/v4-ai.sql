...
CREATE TABLE `ai_chat_agent` (
  ...
  `userId` bigint DEFAULT NULL COMMENT 'userID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='智能体配置';

-- ----------------------------
-- Records of ai_chat_agent
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_chat_message_store
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_kb_knowledge_base
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_kb_knowledge_chunk
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_kb_knowledge_item
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_kb_vector_metadata
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of ai_kb_vectorization_task
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `ai_mcp_server_config` (
  ...
  `env` varchar(100) DEFAULT NULL COMMENT '环境变量(JSON)',
...
-- ----------------------------
BEGIN;
INSERT INTO `ai_model_config` (`id`, `create_by`, `create_name`, `create_time`, `last_modify_time`, `last_modify_by`, `last_modify_name`, `deleted`, `provider`, `model_type`, `model_name`, `api_key`, `base_url`, `variables`, `tenant_id`) VALUES (1998307565570027521, 1, '平台管理员', '2025-12-09 16:23:45', '2025-12-09 16:24:58', 1, '平台管理员', 0, 'OpenAI', 'EMBEDDING', '测试模型', 'key', 'url', NULL, 1);
COMMIT;
