...
) ENGINE=InnoDB AUTO_INCREMENT=1871752260040695810 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='菜单';
...
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `description`, `deleted`, `created_by`, `created_name`, `created_time`, `last_modified_by`, `last_modified_name`, `last_modified_time`) VALUES (110108, '表单设计', 'process:design:form', 1101, '/bpm/process/form-design', '/wemirr/bpm/process/model/form-design', 110107, 'arcticons:efa-publish', 'menu', b'1', NULL, b'0', b'0', b'0', NULL, b'0', 1, '平台管理员', '2024-12-06 14:52:11', 1, '平台管理员', '2024-12-06 14:52:11');
...
INSERT INTO `sys_resource` (`id`, `title`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `type`, `status`, `keep_alive`, `readonly`, `global`, `visible`, `description`, `deleted`, `created_by`, `created_name`, `created_time`, `last_modified_by`, `last_modified_name`, `last_modified_time`) VALUES (3010105, '导出', 'sys:user:export', 30101, '', NULL, 0, '', 'button', b'1', NULL, b'0', b'0', b'1', '用户导出', b'0', 1, '平台管理员', '2024-12-25 10:58:09', NULL, NULL, NULL);
...
CREATE TABLE `t_file_storage` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1871795993318670339 DEFAULT CHARSET=utf8mb3 COMMENT='文件记录表';
