...
INSERT INTO `sys_resource` (`id`, `label`, `permission`, `parent_id`, `path`, `component`, `sequence`, `icon`, `style`, `type`, `status`, `readonly`, `global`, `display`, `description`, `deleted`, `created_by`, `created_name`, `created_time`, `last_modified_by`, `last_modified_name`, `last_modified_time`) VALUES (10602, '站内消息', 'sys:site_notify:page', 106, '/system/message/notify', '/wemirr/system/message/notify/index', 1, 'codicon-repo-push', NULL, 1, b'1', b'0', b'0', b'1', '发布消息', b'0', NULL, NULL, '2020-11-19 02:48:22', NULL, NULL, NULL);
