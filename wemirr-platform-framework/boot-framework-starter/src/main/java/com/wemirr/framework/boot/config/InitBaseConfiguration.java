...
import com.wemirr.framework.boot.config.converter.*;
import com.wemirr.framework.boot.config.redis.DefaultRedisKeyGenerator;
import com.wemirr.framework.boot.config.redis.RedisKeyGenerator;
import com.wemirr.framework.boot.config.redis.RedisSequenceHelper;
...
public class InitBaseConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    @Primary
    public RedisSequenceHelper redisSequenceHelper() {
        return new RedisSequenceHelper();
    }
