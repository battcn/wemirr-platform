...
public class InjectionCore {
        ...
        try {
            ...
            for (Map.Entry<InjectionFieldPo, Map<Serializable, Object>> entries : typeMap.entrySet()) {
                ...
                try {
                    ...
                    Map<Serializable, Object> value = loadMap(extPo);
    ...
    private boolean isNotBaseType(Object obj, Field field) {
        ...
        return !"java.lang.Integer".equals(typeName) &&
                ...
                !"com.wemirr.framework.commons.entity.RemoteData".equals(typeName);
    }
...
//            throw CheckedException.badRequest("数据量过大，请使用 JOIN 查询");
//        }
