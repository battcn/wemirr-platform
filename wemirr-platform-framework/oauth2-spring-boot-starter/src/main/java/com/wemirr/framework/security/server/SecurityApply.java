...
import com.wemirr.framework.security.server.handler.*;
import com.wemirr.framework.security.server.integration.IntegrationAuthenticator;
import com.wemirr.framework.security.server.integration.custom.CustomGrantAuthenticationConverter;
import com.wemirr.framework.security.server.integration.custom.CustomGrantAuthenticationProvider;
import com.wemirr.framework.security.server.integration.device.DeviceClientAuthenticationConverter;
import com.wemirr.framework.security.server.integration.device.DeviceClientAuthenticationProvider;
...
public class SecurityApply {
    ...
    public static void applyFormLoginSecurity(HttpSecurity http, CustomSecurityProperties properties) throws Exception {
        // 指定登录页面
